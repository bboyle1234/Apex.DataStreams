...
namespace Apex.DataStreams.Definitions {
    ...
    /// <summary>
    /// Use this class to build DataStreamDefinition objects. Example:
    /// <code>
    /// var myDefinition = new DataStreamDefinitionBuilder("ExampleDataStream") {
    ///     { "Topic1", 1 }, // Adds the topic
    ///     { "Topic1", 0, typeof(SomeMessageClass), 256 }, // Adds a message to the topic
    /// };
    /// </code>
    /// </summary>
    /// <remarks>
    /// <see cref="IEnumerable"/> is inherited only for the sake of allowing the collection-style constructor initialization demonstrated above.
    /// </remarks>
