...
namespace Apex.DataStreams.Topics {
    ...
    /// <summary>
    /// Every <see cref="IDataStreamTopic"/> has an <see cref="IDataStreamTopicSummary"/>.
    /// The <see cref="IDataStreamTopicSummary"/> is responsible for bringing newly-connected clients up to date
    ...
    public interface IDataStreamTopicSummary : IDisposable {
        ...
        /// <summary>
        /// Called by the <see cref="IDataStreamTopic"/> when a new message is being sent for this particular topic.
